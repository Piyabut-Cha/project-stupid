...
<body>
    ...
    <div class="container">
        <div class="sidebar">
            ...
            <a onclick="searchproduct('meat')" class="sidebar-items">
                เนื้อสัตว์
            </a>
            <a onclick="searchproduct('meatball')" class="sidebar-items">
                ลูกชิ้น
            </a>
            <a onclick="searchproduct('vegable')" class="sidebar-items">
                ผักต่างๆ
            </a>
        </div>
    ...
    <div id="modalDesc" class="modal" style="display: none;">
        ...
        <div class="modal-page">
            ...
            <div class="modaldesc-content">
                <img id="mdd-img" class="modaldesc-img" src=".\imgs\main_menu.jpg" alt="">
